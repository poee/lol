export const meta = {
  title: "Enterprise",
  description: "Tools as development",
};
...
<img
  className="right"
  src="/image/acheulean.jpg"
  data-source="An Acheulean - stone tool after exposure to one million years of human ephemeralization. ~ Wikipedia"
  data-link="https://en.wikipedia.org/wiki/File:Acheuleanhandaxes.jpg"
/>
For *one million years*, these broken river rocks represented the height of human
technology. Eventually, the early humans developed finer control over how the stones
broke, and were able to shape symmetrical pointed handaxes.
...
<a href="/read/complexity" className="next">
  Complexity
</a>
