export const meta = {
  title: "Sefa",
  description:
    "The goal of sefa is not to train yourself to avoid the wandering, but to cultivate a habit of remembering",
};
...
<attr>
  The Seafarer, ~02140 YOLD. Translation by{" "}
  <a href="http://alliteration.net/poetry/seafarer.htm">
...
<attr>
  <i>The First & Last Freedom</i> ~{" "}
  <a href="http://www.jkrishnamurti.org/krishnamurti-teachings/view-text.php?tid=30&chid=56841">
    J. Krishnamurti
  </a>
</attr>
