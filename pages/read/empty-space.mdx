...
<img
  className="flush"
  src="/image/ris.sm.jpg"
  data-source="Heliophysics Resources - NASA"
  data-link="http://sec.gsfc.nasa.gov/sec_resources_imagegallery.htm"
/>
...
<attr>
  Empty space has more energy than everything in the Universe, combined -{" "}
  <a href="http://scienceblogs.com/startswithabang/2012/07/26/empty-space-has-more-energy-than-everything-in-the-universe-combined/">
    ScienceBlogs
  </a>
</attr>

<a
  href="http://scienceblogs.com/startswithabang/2012/07/26/empty-space-has-more-energy-than-everything-in-the-universe-combined/"
  className="next"
>
  read more
</a>
