export const meta = {
  ...
  description: "Every person on this Earth is a genuine and authorized Gnom.",
};
...
_On Etymology:_ Sources disagree regarding the proper translation of the word
~~Gnom~~. Some scholars argue that it should be rendered as ~~Mome~~ or
~~Pope~~, which - though not inaccurate - reflect a preoccupation with gendered
semantic roots, often not corroborated in all versions of the holy texts thus
far uncovered.
