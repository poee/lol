export const meta = {
  ...
  description: "The signs and symbols of the Libber V",
};
...
- Element: Earth
- #9 upon 10
- Who: SOPHIA upon _He-Who-Shall-Not-Be-Named_
- Fourfold Name: AGLA
...
_<small>Libber V is presented using only the evocative postures - the sign of UMBRA is the only invocative posture used. However, the other three postures may be switched out for respective invocative forms as desired:</small>_
...
An invocative posture of the Sun. Give [Van Van Mojo's](/read/beati#vanvanmojo) sign outwardly with both hands.
