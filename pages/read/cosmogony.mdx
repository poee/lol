export const meta = {
  title: "Cosmogony",
  description: "In the beginning there was VOID, who had two daughters.",
};
...
With a faint hum of τῇ καλλίστῃ ('to the most beautiful') the lights did increase…and burn brightly…

A brilliant eye opened and looked back at the sisters from each gleaming
point.
...
_So it is that we do awake from the Chao,  
a still-drowsy yet radiant 👁._

_Our heart reaches for our love Sophia, and we dance with our mother Eris until we return to VOID, where all things begin._
