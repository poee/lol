export const meta = {
  title: "Stage",
  description: "The observable universe is a sphere centered around Earth.",
};

<img
  className="flush"
  src="/image/milkyway.sm.jpg"
  data-source="'Grand Design' Spiral Galaxy M81 ~ HubbleSite Photographs"
  data-link="http://hubblesite.org/newscenter/archive/releases/2007/19/image/a/"
/>
...
<attr>
  <a href="http://www.principiadiscordia.com/book/63.php">
